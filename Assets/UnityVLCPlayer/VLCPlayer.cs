    ...
    public class VLCPlayer : IDisposable
    {
        ...
        private void TrackReaderThread()
        {
            ...
            while (_trackGetAttempts < 10 && _cancel == false)
            {
                ...
                Debug.Log("track.HasValue: " + track.HasValue);
                //Debug.Log("track.i_width: " + track.Value.i_width);
                //Debug.Log("track.i_height: " + track.Value.i_height);
                // RTSP stream do not have the above 2 detail //
